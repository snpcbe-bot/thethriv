...
import { ArrowRight, Users, Badge, Globe, TrendingUp, CheckCircle, Star, Zap, Target, Award } from 'lucide-react';
...
const JoinExpert = () => {
  ...
  const features = [
    ...
    },
    {
      icon: Star,
      title: 'Free Listing',
      description: 'List your services completely free with full platform access and no hidden fees'
    },
    {
      icon: Target,
  ...
  const steps = [
    {
      ...
      description: 'Build your comprehensive expert profile showcasing your skills, experience, and expertise areas'
    },
    {
      number: '02',
      icon: Badge,
    ...
    },
    {
      ...
      description: 'Start receiving inquiries from small businesses worldwide looking for your specific expertise'
    }
  ];
  ...
  return (
    <div className="pt-32">
      {/* Hero Section */}
      <section className="min-h-screen flex items-center bg-gradient-to-br from-purple-50 to-blue-50">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 bg-purple-100 rounded-full">
                ...
                <span className="text-sm font-medium text-purple-900">Join as Expert</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                ...
                <Link
                  to="/experts"
                  className="inline-flex items-center justify-center px-10 py-4 border-2 border-purple-600 text-purple-600 font-semibold rounded-xl hover:bg-purple-50 transition-colors"
                >
                  Learn More
                </Link>
              </div>
              ...
              <div className="text-sm text-gray-500">
                Free listings • No setup fees • Global reach
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="mt-6 text-purple-100">
              Free listings • No setup fees • Cancel anytime
            </div>
          </motion.div>
        </div>
      </section>
