...
import { userProfileService, businessProfileService, expertProfileService, subscriptionService } from './database';
...
export class AuthService {
  ...
  async signIn(email: string, password: string) {
    try {
      ...
      if (data.user) {
        await userProfileService.updateOnlineStatus(data.user.id, true);
      }
